...
func (b *BaseATNConfigSet) getStates() *_set {
...
// OptimizeConfigs optimizes the elements in this object. The method will panic
...
// GetUniqueAlt returns this set's unique alternative.
func (b *BaseATNConfigSet) GetUniqueAlt() int {
	return b.uniqueAlt
}

// SetUniqueAlt sets the unique alternative for this set.
